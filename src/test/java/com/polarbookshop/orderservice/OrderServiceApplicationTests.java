...
class OrderServiceApplicationTests {
	...
	@Test
	void givenNewOrderCreated_whenGettingAllOrders_createdOrderIsReturned() {
		...
		Order expectedOrder = webTestClient
				.post().uri("/orders")
				.bodyValue(new OrderRequest(bookIsbn, 1))
				.exchange()
	...
	@Test
	void whenPostRequest_andBookExists_thenOrderIsAccepted() {
